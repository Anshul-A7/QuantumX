        ...
        <div className="p-4 sm:p-5 border-t border-hairline bg-cream/30 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl border border-hairline bg-cream hover:bg-cream/80 text-ink text-xs font-medium flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-xs"
